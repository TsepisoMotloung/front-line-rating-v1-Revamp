  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="card">
          <div className="card-body">
            <h3 className="text-sm font-medium text-neutral-600 mb-3">Complaint Breakdown</h3>
            <div className="space-y-3">
              <div>
                <p className="text-xs text-neutral-600">Open Complaints</p>
                <p className="text-2xl font-bold text-red-600">{stats?.openComplaints || 0}</p>
              </div>
              <div>
                <p className="text-xs text-neutral-600">Resolved</p>
        ...
        <div className="card">
          <div className="card-body">
            <h3 className="text-sm font-medium text-neutral-600 mb-3">Resolution Rate</h3>
            <p className="text-3xl font-bold text-primary-600">
              {stats?.totalComplaints && stats.totalComplaints > 0 
                ? Math.round((stats.resolvedComplaints / stats.totalComplaints) * 100)
                : 0}%
            </p>
            <p className="text-xs text-neutral-500 mt-2">of total complaints</p>
          </div>
        </div>

        <div className="card">
          <div className="card-body">
            <h3 className="text-sm font-medium text-neutral-600 mb-3">Response Metrics</h3>
            <div className="space-y-3">
              <div>
                <p className="text-xs text-neutral-600">Avg Response</p>
                <p className="text-lg font-semibold text-primary-600">~2 hours</p>
              </div>
              <div>
                <p className="text-xs text-neutral-600">First Contact</p>
