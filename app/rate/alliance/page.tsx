...
export default function RateAllianceInsurancePage() {
  ...
  const fetchQuestions = async () => {
    try {
      setIsLoading(true);
      // Fetch Alliance Insurance rating questions
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      window.location.href = '/rate/success?type=alliance';
    } catch (err: any) {
      setError(err.message);
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-600">
              Share your feedback about Alliance Insurance as a whole
            </p>
          </div>
          ...
          {currentStep === 2 && (
            <div className="card">
              <div className="card-body space-y-8">
                <div>
                  <h2 className="text-xl font-semibold text-neutral-900 mb-6">Rate Alliance Insurance</h2>
